            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="main_nav99">
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> Staffs </a>
                            <ul class="dropdown-menu animate fade-up">
                                <li><a class="dropdown-item icon-arrow" href="/staffs"> Staff List
                                    </a></li>
                                <li><a class="dropdown-item" href="/staffs/create"> Create Staff </a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> Classes </a>
                            <ul class="dropdown-menu animate fade-up">
                                <li><a class="dropdown-item icon-arrow" href="/classes"> Class List
                                    </a></li>
                                <li><a class="dropdown-item" href="/classes/create"> Create CLass </a>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu animate fade-up">
                                <li><a class="dropdown-item icon-arrow" href="#"> Blog single
                                        detail
                                    </a></li>
        ...
        <div class="modal-dialog modal-dialog-aside" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <nav class="list-group list-group-flush">
                        <ul class="navbar-nav ">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active dropdown-toggle  text-dark" href="#"
                                    data-toggle="dropdown">Staffs </a>
                                <ul class="dropdown-menu dropdown-menu-left">
                                    <li><a class="dropdown-item" href="/staffs">Staff List</a></li>
                                    <li><a class="dropdown-item" href="/staffs/create">Create Staff</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active dropdown-toggle  text-dark" href="#"
                                    data-toggle="dropdown">Classes </a>
                                <ul class="dropdown-menu dropdown-menu-left">
                                    <li><a class="dropdown-item" href="/classes">Class List</a></li>
                                    <li><a class="dropdown-item" href="/classes/create">Create Class</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu dropdown-menu-left">
                                    <li><a class="dropdown-item" href="#">Blog details</a>
                                    </li>
                ...
                <div class="modal-footer">
                    <p>© 2020 <a href="https://websolutionus.com/.com">YarlIT</a>
                        -
                        Premium template news, blog & magazine &amp;
                        magazine theme by <a href="https://websolutionus.com/.com">YarlIT.com</a></p>
                </div>
            </div>
        </div>
    </div>
